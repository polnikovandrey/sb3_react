package com.mcfly.template.security;
...
public class UserPrincipal implements UserDetails {
    ...
    public UserPrincipal(Long id, String username, String email, String password, String firstName, String lastName, String middleName, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
    ...
    public static UserPrincipal create(User user) {
        final List<GrantedAuthority> authorities = user.getRoles().stream().map(role -> new SimpleGrantedAuthority(role.getName().getName())).collect(Collectors.toList());
